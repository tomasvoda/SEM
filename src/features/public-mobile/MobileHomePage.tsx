...
export function MobileHomePage() {
    ...
    return (
        <div className="min-h-screen pb-32 page-transition relative overflow-hidden flex flex-col gap-9">
            ...
            <div className="relative px-5 pt-10">
                <div className="flex flex-col gap-6">
                    <div className="relative z-10 ml-0 flex flex-col gap-6">
                        ...
                        {daysUntil > 0 && (
                            <div className="relative z-10 glass-panel py-6 px-6 flex flex-col items-center text-center justify-center overflow-hidden group mt-6">
                                ...
                                <div className="mb-3 w-10 h-10 rounded-xl bg-brand-500/10 flex items-center justify-center border border-brand-500/20">
                                    <Trophy className="w-5 h-5 text-brand-500" />
                                </div>
                                <p className="mobile-metadata-label mb-1">
                                    {t('countdown.title')}
                                </p>
                                <div className="flex flex-col items-center">
                                    <span className="text-5xl font-black text-brand-500 tracking-tighter leading-none mb-1">{daysUntil}</span>
                                    <span className="text-[10px] font-bold uppercase tracking-widest text-[var(--text-muted)]">{t('countdown.days')}</span>
                                </div>
                            </div>
                        )}
                    </div>
                    ...
                    <section className="px-5">
                        ...
                        <div className="glass-panel p-6 relative overflow-hidden group">
                            ...
                            <p className="mobile-body-secondary pr-12 mb-6">
                                {t('sections.volunteers.subtitle').split('\n').map((line: string, i: number) => (
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center gap-4">
                            ...
                            <div>
                                <p className="text-3xl font-black text-brand-500 tracking-tighter leading-none mb-1">{t('sections.stats.program')}</p>
