    ...
    return (
        <div
            ...
            className={cn(
                ...
                "glass border-0 ring-1 ring-white/[0.05] shadow-[0_8px_32px_-8px_rgba(0,0,0,0.3)] rounded-3xl p-6 relative group transition-all duration-500",
      ...
      */}
            <div
                className="absolute inset-0 rounded-3xl pointer-events-none opacity-40 group-hover:opacity-100 transition-opacity duration-700"
                style={{
